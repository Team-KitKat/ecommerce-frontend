...
const Welcome: React.FC = () => {
    return (
        <Row className='welcome-section p-0 mx-0 my-auto'>
            <Col xs={12} lg={12} sm={12} xl={12} md={12} className='p-0 m-0'>
                <Image src={BannerImg} alt="Banner Image" className='banner-image'/>
            </Col>
            <Col xs={{span: 6, offset: 6}} lg={{span: 5, offset: 7}} md={{span: 6, offset: 6}} sm={{span: 6, offset: 6}}
                 xl={{span: 5, offset: 7}} className='banner-content'>
